...
#define BE_LB_HASH_PAT  0x00005  /* hash HTTP body pattern */
...
#define BE_LB_ALGO_BP	(BE_LB_KIND_HI | BE_LB_NEED_HTTP | BE_LB_HASH_PAT) /* hash: HTTP Body parameter pattern*/
